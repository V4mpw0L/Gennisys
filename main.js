...
document.addEventListener('DOMContentLoaded', () => {
  ...
  hero_text: "At <strong class=\"brand-highlight\">Gennisys</strong>, we conceive, design, and operate a proprietary portfolio of applications—no outsourced work, only experiences driven by our product vision.",
  btn_contact: "Contact the Team",
  btn_news: "Product Updates",
  hero_point_1: "Integrated product squads advancing our proprietary mobile, web, and XR platforms.",
  hero_point_2: "AI-first design and engineering powering an ambitious internal roadmap.",
  hero_point_3: "Continuous analytics, live operations, and structured community engagement around our apps.",
  ...
  ceo_text: "Tiago sets the strategic agenda for Gennisys, commanding execution across product, engineering, and audience expansion to uphold our independent vision.",
  ceo_highlight_1_title: "Product Governance",
  ceo_highlight_1_text: "Directs the proprietary roadmap and enforces disciplined delivery for every launch.",
  ceo_highlight_2_title: "Engineering Stewardship",
  ceo_highlight_2_text: "Leads technical excellence, resilient infrastructure, and continuous innovation standards.",
  ceo_highlight_3_title: "Market Relationships",
  ceo_highlight_3_text: "Activates strategic alliances that extend distribution and stakeholder value.",
  ceo_quote: "“We design, validate, and scale the digital products we believe must exist—precise, responsive, and built for leadership.”",
    vision_badge: "Vision 2025",
  vision_title: "End-to-end execution, fully internal.",
  vision_text: "Cross-functional teams align strategy, design, and engineering to convert proprietary innovation into global platforms.",
  ...
  vision_card_1_text: "Modular squads converting validated concepts into production-ready applications within weeks.",
    vision_card_2_title: "AI-First Experiences",
  vision_card_2_text: "Intelligent systems embedded in every product we operate.",
    vision_card_3_title: "Global Readiness",
  vision_card_3_text: "Localization, compliance, and infrastructure engineered for worldwide launches.",
    apps_badge: "Gennisys Portfolio",
    apps_title: "Our Applications",
  apps_subtitle: "Explore the proprietary applications engineered entirely in-house.",
    app_calculator_title: "Smart Calculator",
  app_calculator_desc: "Advanced calculator with scientific functions and audit-ready history tracking.",
    app_calendar_title: "Pro Calendar",
  app_calendar_desc: "Intelligent calendar delivering smart scheduling and executive-grade reminders from our studio.",
    app_maps_title: "Navigation Plus",
  app_maps_desc: "Enhanced mapping solution with resilient offline capabilities from our mobility program.",
    app_games_title: "Mobile Games",
  app_games_desc: "Immersive 2D and 3D games produced by our internal game laboratory.",
    app_utilities_title: "Utility Suite",
  app_utilities_desc: "Essential productivity and optimization tools spanning our ecosystem.",
    app_music_title: "Audio Studio",
  app_music_desc: "Professional audio creation and editing tools from our creator stack.",
  ecosystem_badge: "Build Engine",
  ecosystem_title: "An internal pipeline for breakthrough products.",
  ecosystem_text: "Every discipline collaborates to operate the applications we own, from research through live operations.",
  ...
  ecosystem_column_2_item_1: "Native and cross-platform builds across our stack",
  ...
  partner_slot: "",
  partner_note: "Global technology partners amplifying the reach of our proprietary applications.",
    news_badge: "Newsroom",
  ...
  contact_text: "For inquiries about our apps, media coverage, or strategic partnerships, connect with our studio team.",
  contact_channel_title: "Media & Partnerships",
  contact_channel_text: "Press, distribution, and strategic collaboration requests are welcome.",
  ...
  hero_text: "Na <strong class=\"brand-highlight\">Gennisys</strong>, concebemos, projetamos e operamos nosso portfólio proprietário de aplicativos — nada terceirizado, apenas experiências guiadas pela nossa visão de produto.",
  ...
  hero_point_3: "Analytics contínuos, operações ao vivo e engajamento estruturado da comunidade em torno dos nossos apps.",
  ...
  ceo_text: "Tiago define a agenda estratégica da Gennisys, coordenando execução em produto, engenharia e expansão de audiência para sustentar nossa visão independente.",
    ceo_highlight_1_title: "Governança de Produto",
  ceo_highlight_1_text: "Direciona o roadmap proprietário e assegura entregas disciplinadas em cada lançamento.",
    ceo_highlight_2_title: "Liderança de Engenharia",
  ceo_highlight_2_text: "Comanda excelência técnica, infraestrutura resiliente e padrões contínuos de inovação.",
    ceo_highlight_3_title: "Relacionamentos de Mercado",
  ceo_highlight_3_text: "Ativa alianças estratégicas que ampliam distribuição e valor para stakeholders.",
  ceo_quote: "“Projetamos, validamos e escalamos os produtos digitais que acreditamos que precisam existir — precisos, responsivos e com liderança.”",
    vision_badge: "Visão 2025",
  vision_title: "Execução de ponta a ponta, 100% interna.",
  vision_text: "Equipes multidisciplinares alinham estratégia, design e engenharia para converter inovação proprietária em plataformas globais.",
  ...
  vision_card_1_text: "Squads modulares transformando conceitos validados em aplicações prontas para produção em semanas.",
    vision_card_2_title: "Experiências IA-first",
  vision_card_2_text: "Sistemas inteligentes incorporados em cada produto que operamos.",
    vision_card_3_title: "Prontos para o mundo",
  vision_card_3_text: "Localização, compliance e infraestrutura projetadas para lançamentos globais.",
    apps_badge: "Portfólio Gennisys",
    apps_title: "Nossos Aplicativos",
  apps_subtitle: "Explore os aplicativos proprietários projetados integralmente in-house.",
    app_calculator_title: "Calculadora Inteligente",
  app_calculator_desc: "Calculadora avançada com funções científicas e histórico auditável.",
    app_calendar_title: "Calendário Pro",
  app_calendar_desc: "Calendário inteligente com agendamento estratégico e lembretes em padrão executivo do nosso estúdio.",
    app_maps_title: "Navegação Plus",
  app_maps_desc: "Solução de mapas reforçada com capacidades offline resilientes da nossa frente de mobilidade.",
    app_games_title: "Jogos Mobile",
  app_games_desc: "Jogos 2D e 3D imersivos produzidos pelo nosso laboratório interno.",
    app_utilities_title: "Suíte de Utilitários",
  app_utilities_desc: "Ferramentas essenciais de produtividade e otimização que percorrem nosso ecossistema.",
    app_music_title: "Estúdio de Áudio",
  app_music_desc: "Ferramentas profissionais de criação e edição de áudio do nosso stack para criadores.",
  ecosystem_badge: "Motor de Construção",
  ecosystem_title: "Um pipeline interno para produtos de ruptura.",
  ecosystem_text: "Cada disciplina opera em sincronia para evoluir os apps que nos pertencem, da pesquisa às operações ao vivo.",
  ecosystem_column_1_title: "Pesquisa de Produto",
  ecosystem_column_1_item_1: "Inteligência de audiência & validação de roadmap",
  ecosystem_column_1_item_2: "Sistemas de marca & linguagem de design dos nossos apps",
  ecosystem_column_1_item_3: "Sprints de conceito & laboratórios de protótipos",
  ecosystem_column_2_title: "Núcleo de Engenharia",
  ecosystem_column_2_item_1: "Builds nativos e multiplataforma em todo o nosso stack",
  ...
  news_subtitle: "Acompanhe os marcos que moldam nosso roadmap proprietário.",
  ...
  contact_text: "Para solicitações sobre nossos apps, cobertura de imprensa ou parcerias estratégicas, conecte-se com a nossa equipe de estúdio.",
  contact_channel_title: "Imprensa & Parcerias",
  contact_channel_text: "Pedidos de imprensa, distribuição e colaborações estratégicas são bem-vindos.",
